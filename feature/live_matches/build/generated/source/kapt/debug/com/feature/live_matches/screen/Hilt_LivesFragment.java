...
public abstract class Hilt_LivesFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LivesFragment_GeneratedInjector) this.generatedComponent()).injectLivesFragment(UnsafeCasts.<LivesFragment>unsafeCast(this));
    }
  }
